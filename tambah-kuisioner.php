...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="text-muted card-subtitle mb-2">Pertanyaan</h6><textarea style="width: 850px;max-width: 850px;max-height: auto;"></textarea></div>
            </div><a href="kuisioner.html"><button class="btn btn-primary" type="button" style="margin-top: 20px;margin-right: 40px;">Simpan</button></a></div>
