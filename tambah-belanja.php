    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="input-group" style="margin-left: 20px;margin-top: 20px;">
                <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-align-justify"></i></span></div><input type="text" class="form-control" placeholder="ID Belanja" style="margin-right: 60px;"></div>
            <h3 class="text-dark mb-1" style="margin-left: 20px;">Tanggal Belanja<br></h3><input type="date" style="margin-left: 20px;margin-bottom: 20px;">
                ...
                <div class="col">
                    <form>
                        <div class="field"><select class="form-control"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select>
                            <label
                                class="mb-0" for="float-input">Satuan Bahan Baku</label>
                        </div>
                    </form>
                </div>
            ...
            <div class="card shadow" style="margin-top: 20px;margin-right: 40px;margin-left: 20px;">
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text icon-container" style="width: 145px;"><label>Total Harga Belanja</label></span></div><input type="text" class="form-control" placeholder="Total" style="height: 45px;"></div>
                </div>
            </div><a href="belanja.html"><button class="btn btn-primary" type="button" style="margin-right: 40px;margin-top: 20px;">Simpan</button></a></div>
