    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="input-group" style="margin-left: 20px;">
                ...
                <input type="text" class="form-control" placeholder="Nomor Meja" style="margin-right: 60px;"></div>
            <div class="input-group" style="margin-left: 20px;">
                <div class="input-group-prepend"><span class="input-group-text icon-container"><i
                        class="fa fa-align-justify"></i></span></div>
                <input type="text" class="form-control" placeholder="Jumlah Kursi" style="margin-right: 60px;"></div>
           <a href="meja.html"><button class="btn btn-primary" type="button"
