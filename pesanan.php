...
<div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            <?php topBar($username); ?>
            <div class="container-fluid"><a href="tambah-pelanggan.php">
                    <button class="btn btn-primary" type="button">Tambah Pesanan</button>
                </a>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form name="f" id="f" method="post" action="hasil-cari-pesanan.php?halaman=1">
                                    <div class="text-md-right dataTables_filter" id="dataTable_filter"><label><input
                                                    type="search" class="form-control form-control-sm"
                                                    aria-controls="dataTable" placeholder="Search" name="keyword"
                                                    required id="keyword"></label></div>
                                </form>
                            </div>
