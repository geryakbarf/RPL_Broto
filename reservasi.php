...
if ($_SESSION["jabatan"] != "Pelayan" and $_SESSION["jabatan"] != "Kasir") {
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.php"><i class="fas fa-home"></i><span>Beranda</span></a><a class="nav-link" href="menu.php"><i class="fab fa-readme"></i><span>Menu</span></a><a class="nav-link  active" href="reservasi.php"><i class="fas fa-table"></i><span>Reservasi</span></a>
                        <a
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid"><a href="tambah-reservasi.php"><button class="btn btn-primary" type="button">Tambah Data</button></a>
