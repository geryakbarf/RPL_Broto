...
<body id="page-top">
    <div id="wrapper">
                        ...
                        <ul class="nav navbar-nav text-light" id="accordionSidebar">
                            <li class="nav-item" role="presentation"><a class="nav-link" href="index.php"><i class="fas fa-home"></i><span>Beranda</span></a><a class="nav-link" href="menu.html"><i class="fab fa-readme"></i><span>Menu</span></a><a class="nav-link" href="reservasi.html"><i class="fas fa-table"></i><span>Reservasi</span></a>
                                <a
                                    ...
                                    <a
                                        class="nav-link active" href="kuisioner.html"><i class="fas fa-clipboard"></i><span>Kuisioner</span></a><a class="nav-link" href="dapur.html"><i class="fas fa-warehouse"></i><span>Data Dapur</span></a></li>
                        </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid"><a href="tambah-kuisioner.html"><button class="btn btn-primary" type="button">Tambah Kuisioner</button></a>
                            ...
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td class="text-center"><a href="detail-kuisioner.html">Detail</a></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
