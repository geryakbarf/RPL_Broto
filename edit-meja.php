    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="input-group" style="margin-left: 20px;">
                <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-align-justify"></i></span></div><input type="text" class="form-control" placeholder="Nomor Meja" style="margin-right: 60px;"></div>
            <div class="input-group" style="margin-left: 20px;">
                <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-align-justify"></i></span></div><input type="text" class="form-control" placeholder="Jumlah Kursi" style="margin-right: 60px;"></div>
            <form style="margin-right: 40px;margin-left: 20px;">
                <div class="field"><select class="form-control"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select><label class="mb-0"
                        for="float-input">Status Meja</label></div>
            </form><a href="meja.html"><button class="btn btn-primary" type="button" style="margin-top: 20px;margin-right: 40px;">Perbarui</button></a></div>
