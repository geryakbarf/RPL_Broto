                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-envelope"></i></span></div><input type="text" class="form-control" placeholder="Nomor Pesanan"></div>
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-user"></i></span></div><input type="text" class="form-control" placeholder="Pemesan"></div>
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text icon-container"><i class="fa fa-table"></i></span></div><input type="text" class="form-control" placeholder="Nomor Meja"></div>
                       ...
                       <a href="pesanan.html"><button class="btn btn-primary" type="button">Simpan</button></a></div>
                </div>
            </div>
        </div>
